...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{98, 22862, 23977, 4745537, 5442204, 5594513, 53394607, 57476627, 67859985, 76061764, 78945784, 87367608, 94107066, 142301684, 194589554, 221637784, 234584065, 302979532, 312752480, 328878574, 342947923, 359333139, 362122106, 407283053, 437335495, 452737314, 472591967, 501039929, 520590566, 533026084, 536726916, 537630174, 572311959, 624859580, 630156697, 645494253, 658867884, 721796724, 746281503, 834174833, 863972113, 895762740, 932127235, 946786476, 1067353468, 1067388983, 1085259617, 1103412149, 1177754921, 1181037546, 1203032680, 1204816148, 1224901875, 1228056441, 1247875546, 1253538779, 1257164128, 1273207865, 1275805946, 1280345457, 1280845662, 1282943179, 1352786672, 1398464674, 1431819701, 1436822557, 1460447810, 1512997393, 1532710347, 1547539107, 1620824029, 1621420777, 1623148745, 1648581351, 1692222969, 1705629508, 1768617329, 1813644752, 1825849507, 1915412854, 1916009602, 1937159360, 1953688222, 1953688223, 1981972957, 2025055113, 2053675630, 2054707467, 2082663554, 2127021138, 2137104720};
		
		protected static string[] fields = new string[]{"b", "ft", "kt", "__a", "map", "pop", "_currentAvailable", "getEnumConstructs", "state", "remove", "__previousException", "filter", "_current", "resize", "get_usesAllBits", "__nativeException", "doEncode", "methodName", "get_native", "iterator", "generator", "lastIndexOf", "setBytesSeed", "hasNext", "message", "reverse", "stepNext", "insert", "length", "setStringSeed", "enumerator", "get_message", "native", "nextInt", "array", "nextFullInt", "randomInt", "set_state", "contains", "value", "__nativeStack", "uniform", "random", "toString", "splice", "hasNextBool", "choice", "copy", "__skipStack", "join", "get_state", "concat", "next", "enumConstructor", "push", "usesAllBits", "keyValueIterator", "current", "get_seed", "seed", "sort", "quicksort", "spliceVoid", "getEnumName", "createEnumIndex", "createEnum", "__ownStack", "posInfos", "concatNative", "className", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "shuffle", "toDynamic", "allEnums", "nextCalled", "unwrap", "__get", "__set", "__hx_deleteField", "_state0", "_state1", "lineNumber", "unshift", "set_seed", "enumParameters", "shift", "slice", "_seed"};
